...
interface FooterProps {
  onNavigate: (page: "home" | "movies" | "series" | "animation" | "actors") => void
}

export const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  const handleNavigate = (page: "home" | "movies" | "series" | "animation" | "actors") => {
    window.scrollTo(0, 0)
    onNavigate(page)
  }
        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li>
                <button onClick={() => handleNavigate("movies")} className="footer-link">
                  Movies
                </button>
              </li>
              <li>
              ...
              <li>
                <button onClick={() => handleNavigate("animation")} className="footer-link">
                  Animation
                </button>
              </li>
              <li>
                <button onClick={() => handleNavigate("actors")} className="footer-link">
                  Actors
                </button>
              </li>
            </ul>
